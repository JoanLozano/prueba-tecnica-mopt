...
//   // Configuración responsive: en móviles mostramos 1 por vista,
//   // en pantallas medianas 2, y en pantallas grandes 3 (ajustable).
...
//   return (
//     // contenedor con overflow-hidden para evitar scroll horizontal causado por
//     // elementos absolutamente posicionados dentro de cada card
//     <div className="w-full overflow-hidden">
//       <div ref={sliderRef} className="keen-slider w-full">
//         {testimonials.map((testimonial: any, index: number) => (
//           <div key={index} className={`keen-slider__slide number-slide${index + 1} flex justify-center w-full box-border min-w-0`}>
